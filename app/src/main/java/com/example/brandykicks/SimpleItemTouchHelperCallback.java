...
import com.example.brandykicks.Interface.ItemTouchHelperAdapter;
import com.example.brandykicks.Interface.ItemTouchHelperViewHolder;

public class SimpleItemTouchHelperCallback extends ItemTouchHelper.Callback {
    private final ItemTouchHelperAdapter mAdapter;

    //  This constructor takes an ItemTouchHelperAdapter parameter. When implemented in
    //  FirebaseProductsListAdapter, the ItemTouchHelperAdapter instance will pass the gesture event back to the
    ...
    //  which will eventually handle deleting this item from the user's "Saved Products" in Firebase.
