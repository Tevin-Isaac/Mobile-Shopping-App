...
import com.example.brandykicks.Model.Cart;
import com.example.brandykicks.Prevalent.CartViewHolder;
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()){
                                                        ...
                                                        Intent intent = new Intent(CartActivity.this, com.example.brandykicks.HomeActivity.class);
                                                        startActivity(intent);
                                                    }
                                                }
                                            });
